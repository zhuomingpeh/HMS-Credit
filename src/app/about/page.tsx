...
export default function AboutPage() {
  return (
    <main className="page">
      ...
      <p style={{ marginBottom: "1rem", color: "var(--brand-body)" }}>
        When you choose HMS Credit, you&apos;re working with a licensed moneylender approved by the Ministry of Law.
        We adhere to all regulations set out by the Registry of Moneylenders, so you&apos;ll always have a clear
        understanding of interest rates, fees, and repayment terms before you commit.
      </p>

      <p style={{ marginBottom: "1.5rem", color: "var(--brand-body)" }}>
        Don&apos;t let the thought of borrowing from a licensed moneylender deter you. Visit our office at #01-08
        Sim Lim Square, or fill out our online form, and let us guide you toward a brighter financial future.
      </p>
